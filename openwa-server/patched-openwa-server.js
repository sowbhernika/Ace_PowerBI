// Patched OpenWA Server - Bypass Windows detection issues
...
console.log('🔥 Patched OpenWA server starting on port', port);
console.log('📱 Real OpenWA (@open-wa/wa-automate) v4.50.0');
...
// Patch the problematic modules before requiring OpenWA
function patchWindowsDetection() {
    // Override the os-name module to return a static value
    ...
    Module.prototype.require = function(id) {
        if (id === 'os-name') {
            return function() {
                return 'Windows 10'; // Return static Windows version
            };
        }
        if (id === 'windows-release') {
            return function() {
                return '10'; // Return static Windows version
            };
        }
...
// Initialize OpenWA with patches
async function initializeOpenWA() {
    try {
        console.log('🔧 Applying Windows compatibility patches...');
        patchWindowsDetection();
        
        console.log('📦 Loading OpenWA module...');
